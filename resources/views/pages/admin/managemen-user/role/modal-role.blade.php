            ...
            <div class="modal-body">
                <form id="createRoleForm" name="createRoleForm" class="form-horizontal">
                    <div class="form-group mb-2">
                        <label for="rolename" class="control-label">Nama Role</label>
                        <div class="col-sm-12">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editRoleForm" name="editRoleForm" class="form-horizontal">
                    ...
                    <div class="form-group mb-2">
                        <label for="edit_rolename" class="control-label">Nama Role</label>
                        <div class="col-sm-12">
                            <input class="form-control" id="edit_rolename" name="rolename"
