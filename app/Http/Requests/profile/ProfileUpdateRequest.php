...
class ProfileUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'no_phone' => 'required|string|max:255|unique:m_users,no_phone,' . $this->user()->id,
    ...
    public function messages(): array
    {
        return [
            ...
            'no_phone.max' => 'Nomor telepon tidak boleh lebih dari :max karakter.',
            'no_phone.unique' => 'Nomor telepon sudah digunakan.',
